...
class DataServiceClient:
    ...
    def get_context_compaction_metrics(self, *, hours: Optional[int] = None, limit: Optional[int] = 100) -> Dict:
        if hasattr(self._store, "get_context_compaction_metrics"):
            return self._store.get_context_compaction_metrics(hours=hours, limit=limit)
        return {
            "summary": {
                "session_count": 0,
    ...
    def get_agent_event_rollup_metrics(self, *, hours: Optional[int] = None, limit: Optional[int] = 100) -> Dict:
        if hasattr(self._store, "get_agent_event_rollup_metrics"):
            return self._store.get_agent_event_rollup_metrics(hours=hours, limit=limit)
        return {
            "summary": {
                "total_event_count": 0,
    ...
    def get_report_generation_metrics(self, *, hours: Optional[int] = None, limit: Optional[int] = 100) -> Dict:
        if hasattr(self._store, "get_report_generation_metrics"):
            return self._store.get_report_generation_metrics(hours=hours, limit=limit)
        return {
            "summary": {
                "total_event_count": 0,
                "success_count": 0,
    ...
    def get_rag_retrieval_metrics(self, *, hours: Optional[int] = None, limit: Optional[int] = 100) -> Dict:
        if hasattr(self._store, "get_rag_retrieval_metrics"):
            return self._store.get_rag_retrieval_metrics(hours=hours, limit=limit)
        return {
            "summary": {
                "total_event_count": 0,
                "success_count": 0,
    ...
    def get_learning_signal_summary_metrics(self, *, hours: Optional[int] = None, limit: Optional[int] = 200) -> Dict:
        if hasattr(self._store, "get_learning_signal_summary_metrics"):
            return self._store.get_learning_signal_summary_metrics(hours=hours, limit=limit)
        return {
            "status": "ok",
            "summary": {
                "session_count": 0,
